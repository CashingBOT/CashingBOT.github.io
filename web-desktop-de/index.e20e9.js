System.register(["./application.f0a55.js"], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_applicationF0a55Js) {
      createApplication = _applicationF0a55Js.createApplication;
    }],
    execute: function () {
      createApplication({
